//Array : array is a aboject that stores a collection of element.Arrays can store elements of any data type, including other arrays, and can be dynamically resized.
...
//7.concatinate() : joins two or more arrays and returns a new array.
...
let slicearray = myArray.slice(1,5)
...
//10.forEach(): calls a function for each element in the array. (its behave like loop but does not return anything)

const movies =["GOAT","KGF","3idiots","devratha"];
movies.forEach((i)=>console.log(i));

//11.map(): creates a new array with the results of calling a function for each element in the array.It returns new array.
